...
public class ClimbingState : State
{
    ...
    public override void StateUpdate()
    {
        ...
        {
            agent.animationManager.StartAnimation();
            agent.rb2d.velocity = new Vector2(agent.agentInput.MovementVector.x * agent.agentData.climbHorizontalSpeed, agent.agentInput.MovementVector.y * agent.agentData.climbVerticalSpeed);
        }
        else
        {
            agent.animationManager.StopAnimation();
